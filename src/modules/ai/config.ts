...
export const MODELS = [
  ...
  // ── xAI ───────────────────────────────────────────────────────────────────
  {
    ...
    hint: "Flagship",
    description:
      "Frontier model for coding, long-running agents, and knowledge work.",
    capabilities: { intelligence: 5, speed: 4, cost: 2 },
    tags: ["vision", "reasoning", "tools", "coding"],
  },
  {
    ...
    label: "Grok 4.5",
    hint: "Frontier",
    description: "Previous frontier for coding, agentic, and knowledge work.",
    capabilities: { intelligence: 5, speed: 4, cost: 2 },
    tags: ["vision", "reasoning", "tools", "coding"],
  },
  {
    ...
    hint: "Reasoning",
    description: "1M-context reasoning with strong tool calling.",
  ...
  },
  {
    ...
    label: "Grok 4.20",
    hint: "Fast",
    description: "1M-context chat and tools without extended thinking.",
    capabilities: { intelligence: 4, speed: 4, cost: 3 },
    tags: ["vision", "tools"],
  },
  {
    ...
    hint: "Research",
    description:
      "Multiple agents collaborate in parallel for deep research tasks.",
  ...
  },
  {
    ...
    hint: "Fast",
    description:
      "Fast 1M-context model with strong tool use and instruction following.",
    capabilities: { intelligence: 4, speed: 4, cost: 3 },
    tags: ["vision", "reasoning", "tools", "coding"],
  },
  {
...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  "grok-4.20-multi-agent": { input: 1.25, output: 2.5, cacheRead: 0.2 },
